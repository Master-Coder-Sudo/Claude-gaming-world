...
export const BOOL_SETTINGS = {
  ...
  // off by default: lock action bar slots to prevent accidentally dragging
  // abilities off during combat. When on, ability icons cannot be moved or
  // removed from action bar slots.
  lockActionBar: { def: false },
