...
export const pt_BR: EnTranslations = {
  ...
  "guide": {
    ...
    "professions": {
      ...
      "deedsBody": "O Livro dos Feitos caminha ao lado de cada passo disso. Sua primeira sintonização conquista Jurado da Guilda e sua primeira obra-prima conquista Mestre Artesão, ambos usáveis como títulos. Cada um dos oito ofícios que podem ser conquistados marca um feito de marco nos 50 de habilidade e coroa seu limite com um título de Grão-Mestre, enquanto a Pesca recebe Sal Velho aos 100 de proficiência e o título de Pescador Mestre aos 200.\n\nHá páginas mais discretas também: feitos para sua primeira coleta e primeira criação, pelos achados raros que a sorte traz no campo, e por começar a desmontar. Tudo é cosmético, apenas títulos e Renome. Um feito nunca concede poder; ele apenas prova que você esteve lá.",
    ...
    "profPages": {
      ...
      "craftIntro": {
        "weaponcrafting": "A Forja de Armas é a bancada de armas da forja de Eastbrook: machados, maças, lâminas, lanças e até um cajado para conjuradores, dos iniciantes de cobre ao raro trabalho de tório e arcanita. Uma arma é a melhoria mais sentida que um nível pode comprar, então um ferreiro de armas é o amigo que todo mundo lembra de fazer.",
        "armorcrafting": "A Forja de Armaduras forja cota de malha, a armadura mais pesada que um artesão pode fazer, das básicas de cobre rebitado ao raro conjunto de escama de tório, com alguns itens de atributos para conjuradores à parte. Seus clientes são as pessoas que ficam paradas onde os golpes caem.",
        "tailoring": "A Alfaiataria tece as roupas de Intelecto e Espírito em que os conjuradores vivem, das básicas de linho caseiro até o conjunto de ouro tecido e o raro trabalho de seda solar, e costura a Bolsa de seda, uma bolsa de dez espaços que ninguém jamais recusa.",
      ...
      "craftProse": {
        ...
        "tailoring": {
          ...
          "ladderBody": "Dois campos comuns, as Calças de Lã de Eastbrook e as Vestes Rituais, são conhecidos desde o início e podem ser criados em qualquer lugar. A escada do treinador corre no tear ao sul do poço de Eastbrook: o degrau de linho caseiro (capuz, mitenes, pantufas) é gratuito na habilidade 0, o degrau de ouro tecido (manto, perneiras e a Bolsa de seda) custa 25 prata por receita na habilidade 25, e o degrau raro (veste, manto ombreira, botas) custa 1 ouro cada na habilidade 50.\n\nO Capuz de Trama Protetora não precisa de treinador: todos já o conhecem, mas fica na habilidade 75, vinculado ao tear, como a obra máxima de nível 3 do ofício. Em todo lugar, Ottilie ensina uma receita assim que seu nível em Alfaiataria alcança o nível próprio da receita.",
          "routeHeading": "Obras-primas e um caminho funcional até o 125",
      ...
      "gatherIntro": {
        "mining": "A Mineração extrai minério direto da rocha do mundo: cobre no Vale de Eastbrook, ferro no Brejo de Mirefen e tório em Thornpeak Heights, alimentando os ofícios de forja. Aberta a todos desde o nível 1, sem nenhum requisito, rastreada em seu próprio contador até um limite de 100.",
        "logging": "A Lenharia derruba madeira de árvores em todas as três zonas: casca-de-ferro no Vale de Eastbrook, madeira-de-cinza no Brejo de Mirefen e madeira-anciã em Thornpeak Heights, a matéria-prima para cabos, cajados e a bancada do engenheiro. Aberto a todos desde o nível 1, rastreado em seu próprio contador até um limite de 100.",
        "herbalism": "O Herborismo coleta o que cresce selvagem: folha-prateada no Vale de Eastbrook, folha-dourada no Brejo de Mirefen e pétala-solar em Thornpeak Heights, a folha e o caule que mantêm os ofícios de boticário em atividade. Aberto a todos desde o nível 1, rastreado em seu próprio contador até um limite de 100.",
      ...
      "fish": {
        ...
        "koiHeading": "O Koi de nadadeiras cintilantes",
