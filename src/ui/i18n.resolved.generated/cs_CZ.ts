...
export const cs_CZ: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        "weaponcrafting": "Kovářství zbraní je zbrojní stůl Eastbrookské kovárny: sekery, palcáty, čepele, kopí a dokonce hůl pro sesílatele, od měděných začátků po vzácnou thoriumovou a arkanitovou práci. Zbraň je jedním upgreadem, který hráč na dané úrovni pocítí nejvíce, takže kovář zbraní je přítel, na kterého si každý pamatuje.",
        "armorcrafting": "Zbrojnictví kuje kroužkovou zbroj, nejsilnější brnění, jaké řemeslník dokáže vyrobit, od nýtovaných měděných základů po vzácný sadu thoriumových šupin, s dvojicí kusů se statistikami pro sesílatele po boku. Jeho zákazníci jsou ti, kdo stojí tam, kde přistávají rány.",
      ...
      "gatherIntro": {
        "mining": "Těžba vytahuje rudu přímo ze světového kamene: měď v Eastbrookském údolí, železo v Mirefenském močálu a thorium nahoře v Thornpeakských výšinách, zásobující kovářské živnosti. Přístupné všem od úrovně 1, bez jakékoli podmínky, sledované na vlastním počítadle s limitem 100.",
        "logging": "Dřevorubectví kácí dřevo ze skupin stromů ve všech třech zónách: železová kůra v Eastbrookském údolí, jasanové dřevo v Mirefenském močálu a starší dřevo v Thornpeakských výšinách, hrubý materiál pro topůrka, hole a inženýrský stůl. Přístupné všem od úrovně 1, sledované na vlastním počítadle s limitem 100.",
        "herbalism": "Bylinkářství sbírá, co roste divoce: stříbrnolist v Eastbrookském údolí, zlatolist v Mirefenském močálu a sluncokvět v Thornpeakských výšinách, list a stonek, které zásobují lékárenské živnosti. Přístupné všem od úrovně 1, sledované na vlastním počítadle s limitem 100.",
      ...
      "fish": {
        ...
        "koiHeading": "Koi se třpytivou ploutví",
