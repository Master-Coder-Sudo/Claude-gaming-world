...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        "weaponcrafting": "Оружейное дело кует топоры, булавы, клинки и посохи в кузнице Иствердья: от медных новичковых образцов до редких осмиевых и глифостальных работ.",
      ...
      "gatherDeeds": {
        ...
        "fishing": "Рубеж в 100 вписывает Old Salt, а 200 вписывает Master Angler с его титулом, самую вершину искусства рыбака; Fishing также засчитывается в Master Gatherer, зарабатываемый при 100 в любых трех собирательских ремеслах. Первая рыба из вод каждой зоны заполняет свою страницу, а Sunglint Koi записывает Glimmer of Hope, так что путники с удочкой в котомке заполняют книгу быстрее, чем ожидают."
      },
      "fish": {
        "startHeading": "С чего начать",
