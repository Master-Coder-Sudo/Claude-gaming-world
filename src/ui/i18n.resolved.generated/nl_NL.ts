...
export const nl_NL: EnTranslations = {
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "craftIntro": {
        "weaponcrafting": "Wapensmeden is de wapenbank van de Oostbeekse smidse: bijlen, knuisten, kling en, speren en zelfs een tovenaarssstaf, van koperen starters tot zeldzaam thorium- en arcanietwerk. Een wapen is de meest gevoelde upgrade die een niveau kan kopen, dus een wapensmed is de vriend die iedereen onthoudt te maken.",
        "armorcrafting": "Harnasmaken hakt maliën, het zwaarste pantser dat een vakman kan maken, van geklonken koperen basisstukken tot de zeldzame thoriumschubbenset, met een paar tovenaarsstukken erbij. De klanten zijn de mensen die staan waar de klappen landen.",
        "tailoring": "Kleermaken weeft de stof voor Intellect en Geest waar tovenaarklassen in leven, van homespun-basis door de goudweefset tot zeldzaam zonneweefwerk, en naait het Zijdespun-Ransel, een tas met tien vakken die niemand ooit weigert.",
      ...
      "gatherIntro": {
        "mining": "Mijnbouw haalt erts rechtstreeks uit het gesteente: koper in Eastbrook-Dal, ijzer in Mirefen-Veen, en thorium in Doorntop-Hoogten, als voeding voor de smeedambachten. Open voor iedereen vanaf niveau 1, geen enkele toegangsbeperking, bijgehouden op zijn eigen teller tot een grens van 100.",
        "logging": "Houtkap velt hout uit boomstanden in alle drie zones: ijzerschors in Eastbrook-Dal, essenhout in Mirefen-Veen, en ouderhout in Doorntop-Hoogten, de ruwe grondstof voor schachten, staven en de gereedschapsmakerij. Open voor iedereen vanaf niveau 1, bijgehouden op zijn eigen teller tot een grens van 100.",
        "herbalism": "Kruidenkunde verzamelt wat wild groeit: zilverblad in Eastbrook-Dal, goudblad in Mirefen-Veen, en zonnepetaal in Doorntop-Hoogten, het blad en de stengel die de apotheekambachten draaiende houden. Open voor iedereen vanaf niveau 1, bijgehouden op zijn eigen teller tot een grens van 100.",
