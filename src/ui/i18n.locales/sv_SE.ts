...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.attune.description': 'Markera alla harmoniseringskrav som slutförda.',
  'devCommand.actions.attune.label': 'Lås upp harmoniseringar',
  ...
  'devCommand.actions.gather.description': 'Höj ett insamlingsyrke.',
  ...
  'devCommand.actions.god.description': 'Slå på eller av odödlighet och förstärkt skada.',
  ...
  'hudChrome.partyFrames.healthCurrentMax': 'Nuvarande / Högsta',
  'hudChrome.partyFrames.healthNone': 'Inga',
