...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.craftIntro.weaponcrafting':
    'Vapensmide är vapenbänken hos Östbäckssmedjan: yxor, klubbor, klingor, spjut och till och med en trollkarls stav, från kopparstarters till sällsynta torium- och arkanitarbeten. Ett vapen är den enda uppgradering per nivå som märks mest, så en vapensmed är den vän alla minns att skaffa.',
  'guide.profPages.craftIntro.armorcrafting':
    'Rustningssmide hamrar ringbrynja, den tyngsta rustning en hantverkare kan tillverka, från nitade koppargrunder till det sällsynta toriumfjällsetet, med ett par kastetableringsstycken på sidan. Kunderna är de som står där slagen landar.',
  'guide.profPages.craftIntro.tailoring':
    'Skrädderi väver den Intelligens- och Andeduk trollkarlarna lever i, från hemspunnet bastyg genom guldvävssetet till sällsynt solvävarbete, och syr Silkessömmarens säck, en tioplatspåse som ingen någonsin tackar nej till.',
  ...
  'guide.profPages.gatherIntro.mining':
    'Gruvdrift bryter malm direkt ur världens berg: koppar i Östbäcksdalen, järn i Mirefenkärret och torium uppe i Törntoppens höjder, mat till smedjeyrken. Öppet för alla från nivå 1, ingen som helst spärr, spårat på en egen räknare till ett tak på 100.',
  'guide.profPages.gatherIntro.logging':
    'Skogsavverkning fäller timmer från trädbestånd i alla tre zoner: järnbark i Östbäcksdalen, askved i Mirefenkärret och äldreved i Törntoppens höjder, råvaran till skaft, stavar och ingenjörsbänken. Öppet för alla från nivå 1, spårat på en egen räknare till ett tak på 100.',
  'guide.profPages.gatherIntro.herbalism':
    'Örtkunskap samlar det som växer vilt: silverblad i Östbäcksdalen, guldblad i Mirefenkärret och solkronblad i Törntoppens höjder, blad och stjälk som håller apotekyrkena bubblande. Öppet för alla från nivå 1, spårat på en egen räknare till ett tak på 100.',
  ...
  'guide.profPages.fish.koiHeading': 'Glimmerfenkoien',
  'guide.profPages.fish.koiBody':
    'Varje vattenkälla i spelet gömmer samma pris: Glimmerfenans koi, en ovanlig glans på linan värd 75 koppar till en handlare och ganska mer för din stolthet. Dess odds är en fast 3 procent per landad fångst (4 procent i Törntoppens kalla vatten) vid varje skicklighetsband, och att landa en registrerar Glimmer av hopp i din Bedriftbok, ett noll-ryktbarhetens samlarmärke. När det händer ser loggen till att du vet om det.',
