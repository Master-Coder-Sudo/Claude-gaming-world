...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.craftIntro.weaponcrafting':
    '武器锻造在东溪的锻造坊打造斧、锤、刃与法杖，从铜制入门武器一路到精良的锇金与铭钢之作。',
  'guide.profPages.craftIntro.armorcrafting':
    '护甲锻造在东溪的锻造坊打造锁甲，从铆接铜甲到精良的锇鳞重甲。',
  ...
  'guide.profPages.faq.a6':
    '九种通用的野外配方与工具配方人人从一开始便已知晓，三种绑定作业台的上级配方（窑鳞披肩、织卫兜帽、暮影裹手）也是如此，它们无需训练师，只需对应的作业台。其余一切都由三座枢纽城镇中各作业台旁的常驻师傅传授：多数在东溪，制革师守着芬桥的制革场，炼金师守着高望的药房。\n\n训练师配方分为技能0、25、50三档，作为一次性费用分别是免费、25银和1金。当你在该行业的档位达到配方自身的档位时，师傅便会传授，而且学习时你必须站在其作业台旁：移动作业台不算数。',
  ...
  'guide.professions.deedsBody':
    '功业之书伴随这一切：首次调谐获得Craftsworn，首次杰作获得Masterwright，均可作为头衔佩戴。八种可修行业各在技能50设有里程碑功业，并在上限125加冕Grandmaster头衔；钓鱼在100熟练获得Old Salt，200获得Master Angler头衔。此外还有首次采集、首次制作、野外奇遇与拆解回收的功业。这一切皆为装饰：只有头衔与声望，功业永不赋予力量。',
  ...
  'guide.profPages.gatherDeeds.fishing':
    '钓鱼100熟练铭刻Old Salt，200铭刻Master Angler及其头衔，垂钓技艺的顶点；钓鱼同样计入Master Gatherer（任意三项采集达到100）。在每个区域的水域钓起第一条鱼各有其页，钓起Sunglint Koi则记下Glimmer of Hope。',
  ...
  'guide.profPages.fish.koiBody':
    '全世界的每片水域都藏着同一份大奖：Sunglint Koi，一尾优秀品质的闪光锦鲤，卖给商人值75铜，对你的自豪感则远不止此。它的几率固定为每次起竿3%（Thornpeak的冷水中为4%），不随技能变化，因此码头上的新手与Master Angler机会均等。钓起它会在功业之书记下Glimmer of Hope（零声望的收藏印记）。',
  ...
  'guide.profPages.craftProse.weaponcrafting.identityBody':
    '精良一档就覆盖三种胃口：力量近战的Osmium Warblade、敏捷战士的Glyphsteel War Axe，以及施法者的智力精神法杖Highpine Battle Staff。在制作之轮上它位于护甲锻造与珠宝加工之间；铁匠（武器锻造与护甲锻造）可在Forgemistress Darva处宣誓，与珠宝加工组成的Bladewright则要等后者的配方随未来区域到来。',
  'guide.profPages.craftProse.weaponcrafting.materialsHeading': '锻炉吞噬什么',
  'guide.profPages.craftProse.weaponcrafting.materialsBody':
    '采矿是根基：铜矿出自Eastbrook Vale，铁矿出自Mirefen Marsh，锇矿出自Thornpeak Heights。伐木也很重要：铁皮木做矛杆，梣木做锤柄，一根高松成杖。粗皮从狼和野猪尸体上剥取，碎骨来自日常猎杀，梯子上的配方要烧Smithing Flux（Darva处20铜一罐）。Darva卖锇矿，Tinker Gizzel在工坊卖铭钢锭，价格不菲。',
  'guide.profPages.craftProse.weaponcrafting.ladderHeading': '一级一级的梯子',
  'guide.profPages.craftProse.weaponcrafting.ladderBody':
    '野外配方Eastbrook Arming Sword人人都会、随处可做。真正的梯子是三档九个训练师配方，全部绑定锻造坊：铜档技能0免费，铁档技能25每个25银，锇档技能50每个1金；你的层级一到，Darva就会教。另有一件组合配方Gravewyrm Gauntlets：只有武器锻造与护甲锻造都到25的调谐铁匠能做，且不需要任何工位。',
  'guide.profPages.craftProse.weaponcrafting.routeHeading': '杰作与通往125之路',
  'guide.profPages.craftProse.weaponcrafting.routeBody':
    '有属性的成品（铁档及以上）才可能出杰作；无属性的铜档普通件永远不会触发。铁算一级材料（加成1%），高松与铭钢算二级（2%）。路线：铜档到25，铁档到50，锇档到75；此后暂无更高配方，锇档衰减为半速再到四分之一，到125上限约需再做150次，注意每分钟十次的共享节流。Darva的工作订单每30分钟收八块铜矿。功业之书在技能50记下Edge and Temper，125加冕Grandmaster Weaponcrafting。',
  'guide.profPages.craftProse.armorcrafting.identityHeading': '前线的锁甲',
  'guide.profPages.craftProse.armorcrafting.identityBody':
    '梯子如同士兵的履历：铆接铜甲起步，ironlink一档有了真正的属性，精良的osmiumscale头盔、胸甲与护腿则是工匠能敲出的最大护甲数值。还有安静的一面：野外普通件Eastbrook Warded Leggings与技能75的Kilnscale Mantle（智力精神锁甲肩）留住法系锁甲客户。它位于武器锻造与工程学之间；铁匠对可在Darva处宣誓，Gearwright暂无誓约任务。',
  'guide.profPages.craftProse.armorcrafting.materialsHeading': '成袋的矿石',
  'guide.profPages.craftProse.armorcrafting.materialsBody':
    '没有哪个行业吃矿更快：ironlink hauberk一件就要五块铁矿，每件osmiumscale要三到四块锇矿外加一块铭钢锭，认真的甲匠要么自己挖遍Mirefen Marsh和Thornpeak Heights，要么花钱请人。金属之外还有软料：粗皮、碎骨与亚麻碎布，几乎每个配方都要一罐Smithing Flux（锻造坊20铜）。急用时Darva柜台就卖锇矿。',
  'guide.profPages.craftProse.armorcrafting.ladderHeading': '在Darva的锻炉学艺',
  'guide.profPages.craftProse.armorcrafting.ladderBody':
    '两件野外普通件（Eastbrook Chainmail Vest与Warded Leggings）人人都会、随处可做。训练师梯子是Eastbrook锻造坊的三档九个配方：铜档技能0免费，ironlink档25技能每个25银，osmiumscale档50技能每个1金。梯子之外有两件特例：Boundstone Helm是铁匠组合配方（需调谐且双技能25，不占工位）；Kilnscale Mantle无需老师，但要技能75且绑定锻造坊，是本行业的三层压轴。',
  'guide.profPages.craftProse.armorcrafting.routeHeading': '杰作与通往125之路',
  'guide.profPages.craftProse.armorcrafting.routeBody':
    'ironlink档及以上都掷杰作；只有护甲值的铜档普通件不会触发。铁算一级材料，铭钢算二级。路线照常：铜到25，ironlink到50，osmiumscale到75。75之后的运气在于Kilnscale Mantle：三层配方，到99全速、之后半速，最后五十点约75次而非150次；每件要七块锇矿五份Smithing Flux，先在Thornpeak和锻造坊柜台备货。Darva的订单每30分钟收八块铜矿。技能50记下Hammer and Plate，125等着Grandmaster Armorcrafting。',
  'guide.profPages.craftProse.tailoring.identityHeading': '施法者的布衣，所有人的背包',
  'guide.profPages.craftProse.tailoring.identityBody':
    "梯子从homespun基础布装经gildenweave套装爬到精良档：Silkbinder's Raiment与sunweave件。第二门生意人人需要：Silkspun Satchel是十格背包，没有哪个职业或等级嫌包多。裁缝位于制皮与铭文之间；制装师（制皮与裁缝）在Eastbrook织机旁的Weaver Ottilie处宣誓（先猎四只webwood蜘蛛取丝），与铭文组成的Inkweaver要等铭文的第一批配方。",
  'guide.profPages.craftProse.tailoring.materialsHeading': '线、丝，还有草药',
  'guide.profPages.craftProse.tailoring.materialsBody':
    "织机靠猎获与田野运转：亚麻碎布与家纺布来自人形生物，蜘蛛丝从蛛尸上采取，精良档的核心Silkbinder's Raiment要一块Pristine Silk（尸体采集的署名标本）。草药喂养裁缝胜过任何装备行业：润光叶镶拖鞋，金叶染gildenweave，日瓣草贯穿整个精良档。Spool of Thread在Ottilie处12铜一轴，织机根本不用金属，连Wardweave Cowl顶阶也是用高级草药、Pristine Silk、蛛丝与线织成。",
  'guide.profPages.craftProse.tailoring.ladderHeading': '在Ottilie的织机学艺',
  'guide.profPages.craftProse.tailoring.ladderBody':
    '两件野外普通件（Eastbrook Wool Trousers与Ritual Vestments）随处可做。训练师梯子在Eastbrook水井南侧的织机：homespun档技能0免费，gildenweave档（含Silkspun Satchel）技能25每个25银，精良档技能50每个1金。Wardweave Cowl无需训练师：人人都会，但要技能75且绑定织机，是本行业的三层压轴。',
  'guide.profPages.craftProse.tailoring.routeHeading': '杰作与通往125之路',
  'guide.profPages.craftProse.tailoring.routeBody':
    '长袍里的Pristine Silk本身就补足署名材料加成，金叶与日瓣草分别算一、二级材料，精良档因此触发率最高；背包之类无属性的成品永不触发。路线：homespun到25，gildenweave到50，精良档到75；75之后靠Wardweave Cowl（三层配方，到99全速、之后半速），最后五十点约75次，每次两块Pristine Silk、四束蛛丝、日瓣草与金叶各两、两份线。背包卖给所有人，Ottilie的订单每30分钟收六束蛛丝。技能50记下A Fine Seam，125等着Grandmaster Tailoring。',
  ...
  'guide.profPages.craftProse.leatherworking.materialsBody':
    '在制皮这里，练级路线与供应线是同一条：粗皮直接从带皮尸体上剥取（狼和野猪最多），每具尸体只服务先到的一人。精良及以上的采集还会给出Pristine Hide，Mirewarden Jerkin正需要这种署名标本，见一块存一块。配角不多：蛛腿与蛛丝、人形生物的家纺布、每件mirewarden精良品一块锇矿（Duskhide Wraps顶阶要六块），以及制革坊柜台16铜的Tanning Agent。不想挖矿的话Tanner Hesk也卖锇矿。',
  ...
  'guide.profPages.craftProse.leatherworking.routeBody':
    "marshstalker档及以上都掷杰作，Mirewarden Jerkin里的Pristine Hide自动提供署名材料加成；锇矿算一级材料。无属性的硬皮普通件不会触发。自然而然地练：从一级起剥下每只狼和野猪，硬皮档随地做到25，随任务进沼泽时顺路受训；marshstalker到50，mirewarden到75，此后Duskhide Wraps（三层配方，六块锇矿、三块Pristine Hide、两块粗皮、一份Tanning Agent）带你走完最后五十点（约75次）。75专精后移动制革坊尤其宝贵：营火边就能把一袋皮子变成成品。Hesk的订单每30分钟收八张粗皮。技能50记下Tanner's Trade，上限处是Grandmaster Leatherworking。",
  ...
  'guide.profPages.craftProse.alchemy.materialsBody':
    '每瓶药剂要一个Glass Vial外加对应档位的草药：润光叶生于Eastbrook Vale，金叶生于Mirefen Marsh，日瓣草生于Thornpeak Heights，一区一药，瓶子随世界一起攀升。草药学是天然的伙伴技能；深区的高阶草丛需要更好的镰刀。强化药剂一线另需猎手的材料：从带毒尸体采集的Venom Gland，顶级药剂还要一块Pristine Venom Gland（署名标本）。',
  'guide.profPages.craftProse.alchemy.ladderHeading': '配方阶梯',
  'guide.profPages.craftProse.alchemy.ladderBody':
    'Minor Healing Potion人人初始即会、随处可调。真正的梯子是Verane在药坊教的九个配方，每档三个：技能0免费，25档每个25银，50档每个1金；每档都是治疗药剂、法力药剂与耐力强化剂，从普通润光叶瓶（120生命、160法力）经优秀金叶（200、260）到精良日瓣（280、360）。强化剂同样攀升：Elixir of the Boar给6耐力10分钟，Vipersear Elixir给9耐力15分钟，Elixir of the Serpent给12耐力15分钟且一次两瓶。旁边还有组合配方Elixir of the Bear：炼金25时Verane以25银传授，随处可调，但只有双技能25的调谐爆破师能做。',
  'guide.profPages.craftProse.alchemy.routeHeading': '酿药师的125之路',
  'guide.profPages.craftProse.alchemy.routeBody':
    '药剂永不出杰作，那属于有属性的装备；但名字仍会流传：精良的日瓣药剂单瓶酿造、出瓶即署名，双瓶的Elixir of the Serpent则是无名的。75专精后每个配方省20%材料。早学草药边练边采：润光叶遍布山谷，到了Verane的工作台，免费档就能靠顺手采的草药干净地推到25；25档一开就学，采药转往沼泽，Verane的订单（六株Goldleaf Herb换45铜，每30分钟一次）顺路回本。50以后用Thornpeak的草药酿日瓣与蛇药；100到125是刻意的涓流，酿能卖的，别为数字烧草。技能50记下Strange Brews，上限处是Grandmaster Alchemy。',
  'guide.profPages.craftProse.engineering.identityHeading': '工具匠的独门生意',
  'guide.profPages.craftProse.engineering.identityBody':
    '这门手艺在Eastbrook广场东南角的工坊操持，主人是Tinker Gizzel。每条工具线的1到3级都是寻常商店货，4级与5级只出自工程师之手。它位于炼金术与护甲锻造之间，两条命途是爆破师（工程学与炼金术）与Gearwright（尚不可宣誓）。最要紧的警告：工程学的两档配方都高于爱好与未宣誓者的精良层上限，技能只为主修包含工程学的人（今天即爆破师）增长；谁都能做这些工具，未调谐者只是学不到东西。',
  'guide.profPages.craftProse.engineering.materialsHeading': '材料与前置工具',
  'guide.profPages.craftProse.engineering.materialsBody':
    '每个工具配方都吞掉低一级的工具外加高级材料：四块Osmium Ore加一把Skysilver Mining Pick成为Osmium Mining Pick，再用两块Glyphsteel Bar加锇镐成为Glyphsteel Mining Pick；斧与镰两条线以Ashwood与Highpine Log、Goldleaf与Sunpetal Herb如法炮制。Gizzel在工坊备齐全部六种高级材料，但矿、木、草都能在Mirefen Marsh与Thornpeak Heights自采，自采才有利润；唯一例外是仅商店有售的Glyphsteel Bar，给每件铭钢级工具垫了固定的成本底价。',
