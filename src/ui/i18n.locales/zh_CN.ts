...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.profPages.craftProse.armorcrafting.materialsBody':
    '没有哪个行业吃矿更快：ironlink hauberk一件就要五块铁矿，每件thoriumscale要三到四块锇矿外加一块铭钢锭，认真的甲匠要么自己挖遍Mirefen Marsh和Thornpeak Heights，要么花钱请人。金属之外还有软料：粗皮、碎骨与亚麻碎布，几乎每个配方都要一罐Smithing Flux（锻造坊20铜）。急用时Darva柜台就卖锇矿。',
  'guide.profPages.craftProse.armorcrafting.ladderHeading': '在Darva的锻炉学艺',
  'guide.profPages.craftProse.armorcrafting.ladderBody':
    '两件野外普通件（Eastbrook Chainmail Vest与Warded Leggings）人人都会、随处可做。训练师梯子是Eastbrook锻造坊的三档九个配方：铜档技能0免费，ironlink档25技能每个25银，thoriumscale档50技能每个1金。梯子之外有两件特例：Boundstone Helm是铁匠组合配方（需调谐且双技能25，不占工位）；Kilnscale Mantle无需老师，但要技能75且绑定锻造坊，是本行业的三层压轴。',
  'guide.profPages.craftProse.armorcrafting.routeHeading': '杰作与通往125之路',
  'guide.profPages.craftProse.armorcrafting.routeBody':
    'ironlink档及以上都掷杰作；只有护甲值的铜档普通件不会触发。铁算一级材料，铭钢算二级。路线照常：铜到25，ironlink到50，thoriumscale到75。75之后的运气在于Sootscale Mantle：三层配方，到99全速、之后半速，最后五十点约75次而非150次；每件要七块锇矿五份Smithing Flux，先在Thornpeak和锻造坊柜台备货。Darva的订单每30分钟收八块铜矿。技能50记下Hammer and Plate，125等着Grandmaster Armorcrafting。',
  ...
  'guide.profPages.craftProse.tailoring.materialsBody':
    "织机靠猎获与田野运转：亚麻碎布与家纺布来自人形生物，蜘蛛丝从蛛尸上采取，精良档的核心Silkbinder's Raiment要一块Pristine Silk（尸体采集的署名标本）。草药喂养裁缝胜过任何装备行业：润光叶镶拖鞋，金叶染goldweave，日瓣草贯穿整个精良档。Spool of Thread在Ottilie处12铜一轴，织机根本不用金属，连Wardweave Cowl顶阶也是用高级草药、Pristine Silk、蛛丝与线织成。",
