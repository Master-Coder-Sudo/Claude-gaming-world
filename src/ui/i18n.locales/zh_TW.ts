...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.combatreset.description': '清除戰鬥狀態與敵對仇恨。',
  'devCommand.actions.combatreset.label': '重設戰鬥',
  'devCommand.actions.cooldowns.description': '重設技能、公共冷卻與藥水計時器。',
  ...
  'devCommand.actions.dungeon.description': '略過開發者門檻進入地城。',
