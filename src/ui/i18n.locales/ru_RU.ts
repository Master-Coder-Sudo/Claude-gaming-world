...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.kill.description': 'Проверить переходы между смертью, призраком и телом.',
  ...
  'devCommand.actions.lfgboard.label': 'Заполнить доску групп',
  ...
  'devCommand.actions.revive.description': 'Ожить через обычный процесс воскрешения.',
  'devCommand.actions.revive.label': 'Ожить',
