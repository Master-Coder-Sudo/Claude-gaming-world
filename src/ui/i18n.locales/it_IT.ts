...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.gather.description': 'Aumenta un mestiere di raccolta.',
  ...
  'devCommand.categories.spawns': 'Generazioni',
  ...
  'devCommand.subtitle': 'Controlli di test autorevoli per il mondo attivo.',
