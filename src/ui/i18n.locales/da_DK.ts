...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.attune.description': 'Markér alle adgangskrav som fuldførte.',
  'devCommand.actions.attune.label': 'Lås adgangskrav op',
  ...
  'devCommand.actions.gather.description': 'Forøg et indsamlingsfag.',
  ...
  'hudChrome.partyFrames.healthCurrent': 'Aktuel',
  'hudChrome.partyFrames.healthCurrentMax': 'Aktuel / Højeste',
