...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'devCommand.actions.dungeon.description': 'Geliştirici kapısını atlayarak bir zindana gir.',
  ...
  'devCommand.actions.kill.description': 'Ölüm, ruh ve ceset akışlarını sına.',
  ...
  'devCommand.actions.quest.description': 'Kimliğe göre belirli bir görevi tamamla.',
  'devCommand.actions.quest.label': 'Görevi tamamla',
  'devCommand.actions.quests.description': 'Mevcut kayıt defterindeki tüm görevleri tamamla.',
  ...
  'devCommand.actions.revive.description': 'Normal dirilme yolunu kullanarak yeniden canlandır.',
  'devCommand.actions.revive.label': 'Yeniden canlandır',
  ...
  'hudChrome.dailyRewards.reason.bannedUntil':
    'Günlük Ödüllerden {remaining} daha yasaklısın. Erişim {until} tarihinde geri açılır. Gerekçe: {reason}',
