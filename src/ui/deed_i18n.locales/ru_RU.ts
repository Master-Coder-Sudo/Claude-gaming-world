...
export const table: DeedLocaleTable = {
  ...
  col_glimmerfin: { name: 'Проблеск надежды', desc: 'Поймайте кои солнечного блика.' },
  col_full_creel: {
    name: 'Полный садок',
  ...
  prog_guildsworn: { name: 'Присягнувший ремеслу', desc: 'Настройтесь на пару архетипа и всерьез возьмитесь за ее ремесла.', title: 'Присягнувший ремеслу' },
  exp_first_ore: { name: 'Кирка встречает камень', desc: 'Разработайте свою первую рудную жилу.' },
