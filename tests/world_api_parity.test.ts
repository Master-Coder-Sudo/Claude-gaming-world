...
// it lands the matching edit here in the SAME commit. The count pins (165 / 45 / 120)
...
// The 165 members of `interface IWorld`, in interface order (world_api.ts:342-509).
// Partition: 45 `data` + 120 `method` (read-returning + command-void + 3 async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 21 facets', () => {
  ...
  it('the union of the 21 facets equals the pinned 165-member IWORLD_MEMBERS set', () => {
